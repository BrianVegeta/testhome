module Item::RentOfficehouse
  extend ActiveSupport::Concern

  included do

    with_options if: :is_rent_officehouse? do |form|
      form.after_initialize :set_rent_officehouse_default
      ...
      def set_rent_officehouse_default
    ...
    def is_rent_officehouse?
      return false if self.post_type.nil?
      Item::TYPE_TO_MATCH[self.post_type.to_sym][:model] == 'Item::RentOfficehouse'
    end
  end
