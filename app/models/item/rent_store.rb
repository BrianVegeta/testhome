module Item::RentStore
  extend ActiveSupport::Concern

  included do

    with_options if: :is_rent_store? do |form|
      form.after_initialize :set_rent_store_default
      ...
      def set_rent_store_default
        self.has_parking      = false if self.has_parking.nil?
        self.decorating_level = :simple if self.decorating_level.nil?
      end
    ...
    def is_rent_store?
      ...
      Item::TYPE_TO_MATCH[self.post_type.to_sym][:model] == 'Item::RentStore'
    end
