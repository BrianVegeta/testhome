module Item::RentFactory
  extend ActiveSupport::Concern

  included do

    with_options if: :is_rent_factory? do |form|
      form.after_initialize :set_rent_factory_default
    ...
    def is_rent_factory?
      ...
      Item::TYPE_TO_MATCH[self.post_type.to_sym][:model] == 'Item::RentFactory'
    end
  end
